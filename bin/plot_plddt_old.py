...
if len(sys.argv) != 3:
    print("Usage: python plot_plddt.py <dataset_name> <csv_file>")
    sys.exit(1)
...
# ---------- CONVERT PKL DICT ----------
species_values = {species: list(vals.values()) for species, vals in species_plddt.items()}
...
print(f"Plots saved for dataset: {dataset_name}")
